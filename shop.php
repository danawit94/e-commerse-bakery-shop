    ...
    <div class="box-bottle">
        ...
        <form action="" class="brar" method="post">
            ...
            <div class="icon">
                ...
                <button type="submit" name="add_to_wishlist" class="bi bi-heart" id="only2"></button>
        ...
        ?>
    </div> <!-- MANDATORY: Closes .popular-slider-track row container properly -->
</section> <!-- MANDATORY: Closes .popular section container wrapper cleanly -->

<?php include 'footer.php'; ?> <!-- Positioned safely outside code loop structures -->
</body>
</html>
